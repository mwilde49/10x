...
#SBATCH --output=logs/spaceranger_%j.out
#SBATCH --error=logs/spaceranger_%j.err
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=16
#SBATCH --mem=128G
#SBATCH --exclusive

# Space Ranger manages its own threading via --localcores/--localmem.
...
TENX_WRAPPER=$PROJECT_ROOT/containers/10x/bin/spaceranger-run.sh
...
if [ ! -f "$TENX_WRAPPER" ]; then
    echo "ERROR: Space Ranger wrapper not found at $TENX_WRAPPER"
...
echo "====================================================================="
echo "  HYPERION COMPUTE — Space Ranger Pipeline Executing"
echo "====================================================================="
