...
TENX_WRAPPER=$PROJECT_ROOT/containers/10x/bin/cellranger-run.sh
...
if [ ! -f "$TENX_WRAPPER" ]; then
    echo "ERROR: Cell Ranger wrapper not found at $TENX_WRAPPER"
...
echo "====================================================================="
echo "  HYPERION COMPUTE — Cell Ranger Pipeline Executing"
echo "====================================================================="
